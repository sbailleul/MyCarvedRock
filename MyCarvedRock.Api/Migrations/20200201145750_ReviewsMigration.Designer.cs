...
namespace MyCarvedRock.Api.Migrations
{
    ...
    [Migration("20200201145750_ReviewsMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyCarvedRock.Api.Data.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IntroducedAt = new DateTimeOffset(new DateTime(2020, 1, 1, 15, 57, 49, 615, DateTimeKind.Unspecified).AddTicks(481), new TimeSpan(0, 1, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            IntroducedAt = new DateTimeOffset(new DateTime(2020, 1, 1, 15, 57, 49, 622, DateTimeKind.Unspecified).AddTicks(6366), new TimeSpan(0, 1, 0, 0, 0)),
                            Name = "Army Slippers",
                        ...
                        new
                        {
                            ...
                            IntroducedAt = new DateTimeOffset(new DateTime(2020, 1, 1, 15, 57, 49, 622, DateTimeKind.Unspecified).AddTicks(6491), new TimeSpan(0, 1, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            IntroducedAt = new DateTimeOffset(new DateTime(2020, 1, 1, 15, 57, 49, 622, DateTimeKind.Unspecified).AddTicks(6512), new TimeSpan(0, 1, 0, 0, 0)),
                            Name = "Climbing Kit",
                        ...
                        new
                        {
                            ...
                            IntroducedAt = new DateTimeOffset(new DateTime(2020, 1, 1, 15, 57, 49, 622, DateTimeKind.Unspecified).AddTicks(6581), new TimeSpan(0, 1, 0, 0, 0)),
                            Name = "Blue Racer",
                        ...
                        new
                        {
                            ...
                            IntroducedAt = new DateTimeOffset(new DateTime(2020, 1, 1, 15, 57, 49, 622, DateTimeKind.Unspecified).AddTicks(6610), new TimeSpan(0, 1, 0, 0, 0)),
                            Name = "Orange Demon",
            ...
            modelBuilder.Entity("MyCarvedRock.Api.Data.Entities.ProductReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
...
It's pretty bare bones aside from some dry storage areas and some bungees. It does have a bungee to hold your paddle on the side. I feel it paddles very easy. It goes exactly where I want it to, I didn't struggle to keep it on course. A stiff wind can knock you off track but it was very sturdy and I feel like it would take a lot to tip it over. I stayed fairly dry aside from the dripping off the paddle but its a sit on top so thats to be expected.",
            ...
            modelBuilder.Entity("MyCarvedRock.Api.Data.Entities.ProductReview", b =>
                {
                    b.HasOne("MyCarvedRock.Api.Data.Entities.Product", "Product")
